...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
    	<div class="container">
    		<!--begin::Header-->
    		<div class="header">
            	<img src="<?php echo e(asset(config('layout.resources.logo_email'))); ?>" height="70px"/>
    		</div>
            <!--end::Header-->
    		...
    		<!--begin::Footer-->
            <div class="footer">
    			<div>Copyright &copy; <?php echo e(date('Y').' '.config('app.name')); ?></div>
    			<div>All rights reserved.</div>
            </div>
            <!--end::Footer-->
        </div>
    </body>
</html><?php /**PATH D:\@apollo\@work\@laravel\API_project\public_html\resources\views/layout/email.blade.php ENDPATH**/ ?>