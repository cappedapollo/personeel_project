...
<html lang="en">
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    	...
    	<div class="d-flex flex-column flex-root">
    		<!--begin::Error-->
    		<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo e(asset(config('layout.resources.authorization_img'))); ?>);">
    			<!--begin::Content-->
    			<div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            		...
            		<p class="font-size-h3"><a href="<?php echo e(config('app.url').app()->getLocale()); ?>" class="btn btn-primary btn-lg">Go Back</a></p>
    			</div>
    			<!--end::Content-->
    		</div>
    		<!--end::Error-->
    ...
    <!--end::Body-->
</html><?php /**PATH D:\@apollo\@work\@laravel\API_project\public_html\resources\views/layout/error.blade.php ENDPATH**/ ?>