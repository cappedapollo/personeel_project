...
<div class="row">
	@if(in_array($role_code, array('admin', 'manager')))
    	@include('elements.workforce')
    	@include('elements.log')
    	@include('elements.form')
    	@include('elements.review_type')
    	@include('elements.progress')
    	@include('elements.employee_executed')
