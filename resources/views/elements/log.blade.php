<div class="col-lg-6 col-xxl-4">
	...
	<div class="card card-custom card-stretch gutter-b">
		...
		<div class="card-header">
			<h3 class="card-title">
				<span class="font-weight-bolder text-bblack">{{ trans_choice('menu.log', 2) }}</span>
			</h3>
			<div class="card-toolbar">
				<a href="{{ url(app()->getLocale().'/logs') }}" class="btn btn-clean btn-hover-light-primary btn-sm btn-icon">
			...
			<div class="timeline timeline-6 mt-3">
				@foreach($logs as $log)
    				...
    				<div class="timeline-item align-items-start">
    					...
    					<!--end::Badge-->
    					<!--begin::Text-->
    					<div class="font-weight-bolder text-dark-75 pl-3 font-size-lg">{!! nl2br($action) !!}</div>
    					<!--end::Text-->
    				</div>
    				<!--end::Item-->
				@endforeach
