...
<div class="col-lg-6 col-xxl-4">
	...
	<div class="card card-custom bg-gray-100 card-stretch gutter-b">
		...
		<div class="card-header bg-yellow">
			<h3 class="card-title font-weight-bolder text-bblack">{{ __('form.label.workforce') }}</h3>
			<div class="card-toolbar">
				<a href="{{ url(app()->getLocale().'/users') }}" class="btn btn-clean btn-hover-light-primary btn-sm btn-icon">
			...
			<div class="card-spacer mt-n25">
				...
				<div class="row m-0">
					<div class="col bg-primary px-6 py-8 rounded-xl text-primary mr-7 mb-7 text-white">
						<span class="d-block my-2">
							...
							<span class="font-size-h3 font-weight-bolder ml-3">{{ $employee_count }}</span>
						</span>
						<span class="font-weight-bold font-size-h6 mt-2">{{ $employee_text->$field.'s' }}</span>
					</div>
					<div class="col bg-warning px-6 py-8 rounded-xl text-white mb-7">
						<span class="d-block my-2">
							<i class="fas fa-user-check icon-2x text-white"></i>
							<span class="font-size-h3 font-weight-bolder ml-3">{{ isset($user_counts['manager']) ? $user_counts['manager'] : 0 }}</span>
						</span>
						<span class="font-weight-bold font-size-h6">{{ $manager_text->$field.'s' }}</span>
					</div>
				</div>
				<!--end::Row-->
				<!--begin::Row-->
				<div class="row m-0">
					<div class="col bg-bblack px-6 py-8 rounded-xl mr-7 text-white">
						...
						<span class="font-weight-bold font-size-h6 mt-2">{{ __('form.label.date_today') }}</span>
						<div class="font-weight-bold font-size-h6 mt-2">{{ $today }}</div>
					</div>
					<div class="col bg-dark-yellow px-6 py-8 rounded-xl text-white">
						<span class="d-block my-2">
							<i class="flaticon2-hourglass-1 icon-2x text-white"></i>
						</span>
						<span class="font-weight-bold font-size-h6 mt-2">{{ __('form.label.until_eoy') }}</span>
						<div class="font-weight-bold font-size-h6 mt-2">{{ trans_choice('form.label.week', 2).': '.$remaining_weeks }}</div>
					</div>
				</div>
				<!--end::Row-->
			</div>
