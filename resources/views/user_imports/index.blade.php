		...
		<div class="card card-custom gutter-b">
			<div class="card-header">
        		<div class="card-toolbar">
					...
					<a href="{{ config('app.celery_login_url').'/oauth2/authorize?scope=offline_access&client_id=8f771a5a-15a9-47ab-9670-1f8c09a1722b&response_type=code&redirect_uri='. urlencode(url('/celery/callback')) }}" class="btn btn-outline-danger mr-2">Import From Celery</a>
